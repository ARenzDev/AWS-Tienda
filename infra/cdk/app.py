...
user_pool_stack = CognitoUserPoolStack(app, "CognitoUserPoolStack", env=APP_ENV)

lambda_apigw_stack = HelloWorldLambdaFnStack(
    app, "HelloWorldLambdaFnStack", env=APP_ENV
)
lambda_apigw_stack.add_dependency(user_pool_stack)

apigw_stack = CognitoProtectedApiStack(
    app,
    "CognitoProtectedApiStack",
